    ...
    def camInference(self):
        ...
        while self.stopQ.empty():
            ...
            for instance in detections_df.iloc:
                x = int(instance["left"]*aspect_ratio_x)
                y = int(instance["top"]*aspect_ratio_y)
                w = int(instance["right"]*aspect_ratio_x)-x
                h = int(instance["bottom"]*aspect_ratio_y)-y
